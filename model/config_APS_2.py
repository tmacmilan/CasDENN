...
DATA_PATHA = "../data/aps/aps_data_7"
cascades  = DATA_PATHA_pre+"/APS_preprocessing.txt"
datasetName='aps_7years_'
...
observation = 7*365*24*60*60-1 ##7 years
...
lmax = 2
degree_interval_list = [0,1,2,3,5,8,10,15,20,30,50,70,80,100,150]
